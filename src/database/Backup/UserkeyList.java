...
public class UserkeyList implements Serializable{
    ...
    public void Register(){
        ...
        UserData uData = new UserData(id, name, surname, gender, nationality,religion, birthDate, phoneNumber, address, expDate,isDate);
                                        ...
                                        while(bInp!=0){
                                            ...
                                            switch(bInp){
                                                        ...
                                                        while(configMenuInp != 0){
                                                            ...
                                                            switch(configMenuInp){
                                                                ...
                                                                case 2:
                                                                    ...
                                                                    int AccountNumberChangeInp = sc.nextInt();
                                                                    for(int i=0;i<cofigData.accountList.size();i++){
                                                                        if( cofigData.accountList.get(i).getAccountNumber() ==  AccountNumberChangeInp){
                                                                            System.out.println("This Account Number is Being Used Pls Enter the New One");
                                                                            AccountNumberChangeInp = sc.nextInt();
                                                                            i = 0;
                                                                        }
                                                                    }
                                                ...
                                                case 2:
                                                    ...
                                                    System.out.println("AccountNumberRandomLogic is not avalable");
                                                    creatingAccount.setAccountNumber(1111);
